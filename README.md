...
- **Legacy Step Scripts** — `step1_catalog.py` and `step2_scrape_details.py` are the original two-step versions of the scraper, kept for reference.
...
├── step1_catalog.py             # Legacy: catalog-only scraper
├── step2_scrape_details.py      # Legacy: detail-only scraper
